...
```
. <(wget -qO- https://raw.githubusercontent.com/Egozit/haqq-monitoring/main/haqq-monitoring-install.sh)
```
...
```
git clone https://github.com/Egozit/haqq-monitoring.git
cd haqq-monitoring
nano variables.sh
```
...
## [Dashboard link](http://95.216.2.219:3000/d/Haqq/haqq-monitoring-by-l0vd?orgId=1&refresh=30s)
